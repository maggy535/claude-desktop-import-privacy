...
- It does not transmit your data to the developer or to any third party.

- It does not sell, share, or use your data for advertising.

- It does not contain analytics, trackers, or telemetry.

- It does not run any remote or externally-hosted code.

- It does not read, store or transmit your passwords or login credentials.

- It does not use your data for creditworthiness or lending decisions.
...
**7.1.** The archive is intended to be opened by D.A.V.E., a desktop application that imports your chats into your own computer. This is optional: the archive is an ordinary ZIP file and is yours to keep, open or delete however you wish.

**7.2.** If you do use it, the app reads the archive locally, from your disk. The archive is not uploaded, and the developer does not receive it at any point.

## 8. Data retention

**8.1.** Because no data ever leaves your device, the developer retains nothing. The only copy of your exported data is the ZIP file on your own computer, which you fully control and can delete at any time.
...
**10.1.** If this policy changes, the updated version will be published at this URL and takes effect on publication.

## 11. Contact

Developer contact — Email: hello@dave.space
